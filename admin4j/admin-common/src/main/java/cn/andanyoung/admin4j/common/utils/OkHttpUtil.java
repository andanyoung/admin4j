...
public class OkHttpUtil {
  private static final Logger logger = LoggerFactory.getLogger(cn.andyoung.mp.common.util.OkHttpUtil.class);

  private static OkHttpClient okHttpClient;

  @Autowired
  public OkHttpUtil(OkHttpClient okHttpClient) {
    cn.andyoung.mp.common.util.OkHttpUtil.okHttpClient = okHttpClient;
  }
