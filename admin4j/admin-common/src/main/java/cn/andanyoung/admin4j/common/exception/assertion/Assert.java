package cn.andanyoung.admin4j.common.exception.assertion;

import cn.andanyoung.admin4j.common.exception.BaseException;
import cn.andanyoung.admin4j.common.exception.WrapMessageException;
...
public interface Assert {
  ...
  /**
   * 创建异常. 先使用 {@code errMsg} 创建一个 {@link WrapMessageException} 异常,
